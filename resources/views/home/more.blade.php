    ...
    <div class="UG_list_b"  action-type="feed_list_item" href="#">
        ...
        <div class="list_des">
            ...
            <div class="subinfo_box clearfix">
                ...
                <span class="subinfo_rgt S_txt2"><em class="W_ficon ficon_praised S_ficon W_f16">ñ赞</em><em>{{$v->praise_count}}</em></span>
                <span class="rgt_line W_fr"></span>
                <span class="subinfo_rgt S_txt2"><em class="W_ficon ficon_repeat S_ficon W_f16">评论</em><em>{{$v->reply_count}}</em></span>
                <span class="rgt_line W_fr"></span>
                <span class="subinfo_rgt S_txt2"><em class="W_ficon ficon_forward S_ficon W_f16">转发</em><em>{{$v->tran_count}}</em></span>
            </div>
        </div>
    </div>
@endforeach