...
<body class="FRAME_page B_page S_page" style="background-repeat: repeat;background-image: url('{{session('user')['bg']}}'">
                            ...
                            <div class="lev_box">
                                <ul class="lev_list">
                                    ...
                                    <li class="lev expand S_line2">
                                        <a href="/home/myatt" node-type="lev"  bpfilter="page"><em class="W_ficon ficon_p_follow S_ficon">á</em><span class="W_f14 S_txt1">全部关注</span><em class="num S_txt1">{{count($attcount)}}</em></a>
                                        <ul class="lev2_list">
                                    ...
                                    <li class="lev S_line2">
                                        <a class="lev_a current S_bg1" href='/home/fans' bpfilter="page" node-type="lev" class="lev_a SW_fun_bg" class-touch="lev_a SW_fun_bg_active"><em class="W_ficon ficon_fans S_ficon S_ficon_dis">à</em><span class="W_f14 S_txt1">粉丝</span><em class="num S_txt1">{{count($fans)}}</em></a>
                                    </li>
            ...
            <div class="WB_tab_b" node-type="relationnav">
                <div class="opt_choose">
                    <div class="inner S_line2 clearfix">
                            ...
                            <li class="tab_li"><span class="tab_item tab_cur S_line1 textcut"><span class="W_f14 S_txt1">粉丝</span><em class="attach S_txt1">{{count($fans)}}</em><em class="attach S_txt2" title=""></em></span></li>
                        </ul>
                                                                    </div>
                </div>
                ...
                <div class="opt_bar clearfix S_bg2" node-type="navTools">
                    <div class="W_fl">
                        ...
                        <div class="search_box">
                            <span class="WB_search_s"><input autocomplete="off" node-type="searchInput" value="输入昵称或备注" notice="输入昵称或备注" class="W_input" type="text"><span class="pos"><a node-type="searchBtn" title="搜索" class="W_ficon ficon_search S_ficon">f</a></span></span>
                        </div>
                    </div>
                                    </div>
    ...
    <ul class="member_ul clearfix" node-type="relation_user_list">
            ...
            <div class="member_wrap clearfix">
                <div class="mod_pic S_line1">
                    <p class="pic_box"><a action-type="ignore_list" target="_blank" href="https://weibo.com/qhsbs?from=myfollow_all" class=""><img src="bd130f40jw8f1d4npp3ysj20yi0yi76r.jpg" title="郑州美食频道" usercard="id=3172142912" alt="郑州美食频道" class="W_face_radius" height="50" width="50"></a></p>
                </div>
                <div class="mod_info">
                    <div class="title W_fb W_autocut ">
                    <a href='/home/homepages/666666{{$fans[$i]->nick_name}}' target="_blank" action-type="ignore_list" node-type="screen_name" href="https://weibo.com/qhsbs?from=myfollow_all" class="S_txt1" title="郑州美食频道" usercard="id=3172142912">
                    ...
                    本地资讯博主（郑州）http://t.cn/RUmMhZ7                                        </div>
                                        <div class="info_from S_txt2">

                                        <div class="opt">
                        <p class="btn_bed"><a class="W_btn_b" action-data="gid=0&amp;nick=郑州美食频道&amp;uid=3172142912&amp;sex=f" diss-data="refer_sort=relationManage&amp;location=myfollow&amp;refer_flag=add" action-type="relation_setGroup" node-type="setGroupBtn" title="未分组"><span node-type="groupName" class="txt W_autocut">未分组</span><em class="W_ficon ficon_arrow_down_lite S_ficon">g</em></a><a class="W_btn_b btn_set set" action-type="relation_hover" id='leave'><em node-type="setGroupIcon" class="W_ficon ficon_setup S_ficon">J</em></a></p>
                        <div class="layer_menu_list setlist" style="left: 90px; z-index: 99; display: none;" node-type="layer_hover_list" action-type="relation_hover_more">
                            <ul>
                            	<li><a id='{{$fans[$i]->user_id}}' class='dofans' action-type="cancel_follow_single">移除粉丝</a></li>
                                                                                            </ul>
                        </div>
                    </div>
		...
		<p class="icon"><span class="W_icon icon_warnS"></span></p>
		<p class="txt">智能反垃圾系统自动清除了部分广告用户，如有疑问请点击<a href="http://help.weibo.com/faq/q/417/14042#14042">这里</a>查看。</p>
	</div>
    </div>
    ...
    <div class="W_pages">
		<a class="page prev S_txt1 S_line1 page_dis"><span>上一页</span></a>
									...
									<a bpfilter="page" class="page S_txt1 S_bg1">1</a>
														<a bpfilter="page" class="page S_txt1" href="https://weibo.com/p/1005055322078304/myfollow?t=1&amp;pids=Pl_Official_RelationMyfollow__93&amp;cfs=&amp;Pl_Official_RelationMyfollow__93_page=2#Pl_Official_RelationMyfollow__93">2</a>
							
					<a bpfilter="page" class="page next S_txt1 S_line1" href="https://weibo.com/p/1005055322078304/myfollow?t=1&amp;pids=Pl_Official_RelationMyfollow__93&amp;cfs=&amp;Pl_Official_RelationMyfollow__93_page=2#Pl_Official_RelationMyfollow__93"><span>下一页</span></a>
				</div>
</div>
            </div>
    </div>
...
//移除粉丝
	$('.dofans').each(function(){
		...
		$(this).click(function(){
			...
			$.post('/home/delfans',{id:id,'_token':'{{csrf_token()}}'},function(data){
...
//关注粉丝
	$('.attfans').each(function(){

		$(this).click(function(){

			ids = $(this).attr('id');
			$.post('/home/attfans',{id:ids,'_token':'{{csrf_token()}}'},function(data){
