...
<body>
	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
            	<img src="{{URL('admin/images/mws-logo.png')}}" alt="mws admin">
			</div>
        </div>
        ...
        <div id="mws-user-tools" class="clearfix">
            ...
            <div id="mws-user-info" class="mws-inset">
            	...
            	<div id="mws-user-photo">
                	<img src="{{URL('admin/example/profile.jpg')}}" alt="User Photo">
                </div>
    ...
    <script src="{{asset('/admin/plugins/flot/plugins/jquery.flot.pie.min.js')}}"></script>
