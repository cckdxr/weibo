        ...
        <div id="mws-container" class="clearfix">
            <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span><i class="icon-pencil"></i>分类列表</span>
                </div>
                <div class="mws-panel-body no-padding">
                    <form id='first' class="mws-form" action="/admin/doupload" enctype="multipart/form-data" method="post">
                        {{csrf_field()}}
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                分类名称：<input type="text" name="field_name">
                            </div>
                            <input type='hidden' name='picadd' value='' id='picadd'>
                            <div class="mws-form-row">
